...
Cuba.define do
  ...
  on "laboratories" do 
    ...
    on root do 
      ...
      on get do
        res.status = 200
        res['Content-Type'] = 'application/json'
        puts "GET de laboratorios"
        res.write(JSON.dump(Tabula::LaboratoryTemplate.instance.select(req.params)))
      end
      ...
      on post do 
        ...
        Tabula::LaboratoryTemplate.instance.insert(req.params)
        res.status = 200
        res['Content-Type'] = 'application/json'
        res.write ''
      end
    ...
    on ":template_id" do |template_id|
      ...
      on delete do
        Tabula::LaboratoryTemplate.instance.delete(template_id)
        res.status = 200
        res.write ''
      end
    end
  ...
  on get do
    ...
    [root, "about", "pdf/:file_id", "help", "mytemplates", "mylaboratories"].each do |paths_to_single_page_app|
